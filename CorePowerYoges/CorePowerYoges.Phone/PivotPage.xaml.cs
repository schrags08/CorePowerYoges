...
using CorePowerYoges.Phone.Common;
using CorePowerYoges.Phone.Data;
using CorePowerYoges.Phone.Repository;
using System;
...
namespace CorePowerYoges.Phone
{
    public sealed partial class PivotPage : Page
    {
        ...
        /// Invoked when an item within a section is clicked.
        /// </summary>
        private void ItemView_StateClick(object sender, ItemClickEventArgs e)
        {
            // Navigate to the appropriate destination page, configuring the new page
            // by passing required information as a navigation parameter
            var stateId = ((State)e.ClickedItem).Id;
            if (!Frame.Navigate(typeof(ItemPage), stateId))
            {
                throw new Exception(this.resourceLoader.GetString("NavigationFailedExceptionMessage"));
            }
        }        
        ...
        private async void ThirdPivot_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            this.DefaultViewModel["AllStates"] = allStates;
        }
