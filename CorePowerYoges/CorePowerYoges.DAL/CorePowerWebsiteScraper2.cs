...
namespace CorePowerYoges.DAL
{
    ...
    /// </summary>
    public class CorePowerWebsiteScraper2 : IDailySchedule2Repository
    {
        ...
        /// </summary>
        public CorePowerWebsiteScraper2(string urlBaseFormatString,
        ...
        {
            var schedule = new DailySchedule2(date.Date);
            ...
            try
            {
                using (var client = new WebClient())
                {
                    ...
                    foreach (HtmlNode node in rawClasses)
                    {
                        ...
                        var session = new Session2(startTime, endTime, name, teacher);
